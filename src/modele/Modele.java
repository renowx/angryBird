...
public class Modele {
    ...
    public Modele(){
        ...
        while(i!=nbObstacle){
            ...
            listeObstacle.add(new Obstacle(1400,(getListeObstacle().get(taille).getY()+100),50+new Random().nextInt(50))); // obstcle située de 100 en dessous de l'obtacle précédant, table variable entre 50 et 100
        i++;
        }
