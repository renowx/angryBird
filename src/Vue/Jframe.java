...
public class Jframe extends JFrame {
    ...
    private void go() {
		...
		// Arret de l'objet a ameliorer
                ...
                if(obstacle==null){ // pas de rencontre d'obstacle mais peut être rencontre du bord
                    if (oiseau.getPosX() == this.getWidth() - 100 || oiseau.getPosY() == this.getWidth() - 100 || oiseau.getPosX() == this.getHeight() - 100 || oiseau.getPosY() == this.getHeight() - 100){
